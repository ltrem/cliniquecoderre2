 ...
 */
class Version20170204211706 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE communication (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, dateSent DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, phone_cell_carrier_id INT DEFAULT NULL, client_id INT DEFAULT NULL, employe_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, phone_cell VARCHAR(255) NOT NULL, phone_work VARCHAR(255) DEFAULT NULL, phone_home VARCHAR(255) DEFAULT NULL, INDEX IDX_4C62E63872451E7 (phone_cell_carrier_id), INDEX IDX_4C62E63819EB6921 (client_id), INDEX IDX_4C62E6381B65292 (employe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, employe_id INT DEFAULT NULL, event_cancellation_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, name VARCHAR(255) NOT NULL, startTime DATETIME NOT NULL, endTime DATETIME NOT NULL, INDEX IDX_3BAE0AA719EB6921 (client_id), INDEX IDX_3BAE0AA71B65292 (employe_id), UNIQUE INDEX UNIQ_3BAE0AA7D5419431 (event_cancellation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE event_reminder (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, communication_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_6DBA69071F7E88B (event_id), UNIQUE INDEX UNIQ_6DBA6901C2D1E0C (communication_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE event_cancellation DROP FOREIGN KEY FK_16DD57FF1C2D1E0C');
